...
const Navbar = () => {
  ...
  return (
    ...
    text-white bg-black px-4'>
      <div>
            <h1 className='text-5xl font-signature ml-2 pt-3'>1Njeru</h1>
      </div>
...
<Link onClick={() => setNav ( !nav )}  to={link} smooth >{links}</Link>
</li>
</div>
            ))}
  </ul>
      ...
      <div onClick={() => setNav ( !nav )} className='cursor-pointer pr-4 z-10 pt-3
